...
<aside id="top-bar-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
        <a href="{{route('dashboard')}}" class="flex items-center ps-2.5 mb-5">
            <!-- <img src="{{asset('images/logo.svg')}}" class="h-6 me-3" alt="Logo" /> -->
            <span class="self-center text-lg text-heading font-semibold whitespace-nowrap">InventarisBarang</span>
        </a>
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{route('barang.index')}}" class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
            ...
            <li>
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <a :href="route('logout')"
                        ...
                        class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group cursor-pointer">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-fg-brand" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
